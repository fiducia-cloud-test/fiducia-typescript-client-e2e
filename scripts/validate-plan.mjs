// generated by zed-pkg-test/test-org-fleet; keep this fix synchronized with the factory template.
...
if (fs.existsSync(new URL('../.gitmodules', import.meta.url))) {
  // Nested gitlinks are omitted by a non-recursive ls-tree. Use -r so
  // vendor/<dependency> entries are actually visible to the validator.
